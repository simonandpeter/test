...
- Unit: `tests/*.test.mjs`, `npm test` (~13s, 213).
- Browser: `e2e/`, one file per surface, 596 across two projects —
...
| `views/map.js`, `map.css`, `lib/mercator.js`, `lib/regions.js` | `map.spec.js` |
