...
- **862 saints**, every one with a life; **1221 venerated attestations** —
  ...
  says so. **138 undated** (2026-09-06 night; 154 when this block was written);
...
| `no-birth` | 382 | was 490 on 2026-09-05 and 457 on the morning of 2026-09-06; the thirty-three came from the azbyka lives of the new martyrs, and the next nine from the same day's later readings — Job of Pochaev, Daniel of Moscow, the new martyrs of 20 September, Gorazd, Raphael of Šišatovac and the two Peters of 8 and 17 September among them. Then sixty-one more on the night of 2026-09-06 from the lives' own first sentences — fifty-seven said "born in YEAR" and the saint.json never had it, and four more were arithmetic (twenty in 1822). The rest is mostly irreducible; the 42 modern saints still without one are joint-life companions and one-line new martyrs whose pages give no year |
